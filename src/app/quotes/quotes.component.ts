...
export class QuotesComponent implements OnInit {
  ...
  quotes:Quote[] = [
    ...
    new Quote (5,'Abdirahman', 'Education', 'Education is the passport to the future,for tomorrow belongs to those who prepare for it today.', 'Malcom X', new Date(2021,11,30),0,0)
  ];
  get sortQuotes() {
